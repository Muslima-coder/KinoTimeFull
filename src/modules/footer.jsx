...
const Footer = () => {
  ...
  return (
   <div className="!bg-[#1D1F1E] !px-0 sm:!px-[50px] md:!px-[10px] w-full py-3">
    <div className="containers">
      <div className="w-full border-b-[1px] border-[#242525] flex-wrap flex flex-col sm:flex-row items-start gap-10 lg:py-[35px]">
