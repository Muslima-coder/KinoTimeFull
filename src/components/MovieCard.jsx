...
export default function MovieCard({ title, poster, year, imdbRating, genre, country }) {
  return (
    <div>
    <div className="movie-card xl:w-[229px] rounded-[10px] overflow-hidden w-[200px] pt-[20px]  flex-shrink-0">  
      ...
      <p className="text-[15px] font-normal m-0 line-clamp-1">{genre} | {country}</p>
        ...
        <div className="flex pr-[10px] text-center items-center">
        <SearchIMDBIcon/>
        <p className="text-{#fff] text-[14px] pr-[10px] font-semibold text-center justify-center items-center">{imdbRating}</p>
        <div  className="flex" >
        <Icon2/>
